...
const Home = () => {
    return (
        <div className="home">
            ...
            <p>
                With a strong background in Chemistry and an ever-growing passion for software development,
                I am eager to take on new challenges and make a positive impact in the tech industry.
            </p>
        </div>
    );
};
